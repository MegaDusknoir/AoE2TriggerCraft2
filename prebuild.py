...
def createCeAttributeDict(outPath):
    ...
    with open(f'{package_path}/versions/DE/v1.58/effects.json', 'r', encoding='utf-8') as f:
        effectStruct = json.load(f)
    with open(f'{package_path}/versions/DE/v1.58/conditions.json', 'r', encoding='utf-8') as f:
